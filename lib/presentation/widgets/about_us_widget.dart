  ...
  List<Widget> _buildItems(
    ...
    final items = [
      [
        ...
        'Более 1 тыс единиц готовой продукции в неделю, в зависимости от сложности модели'
      ],
      [
        '2',
        'Оперативная калькуляция',
        'Отправьте нам фото и узнайте стоимость пошива вашего изделия за 30 минут'
      ],
      [
        '3',
        'Эталонный образец',
